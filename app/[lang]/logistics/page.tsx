...
const dictionaries = {
  en: {
    dir: "ltr",
    navHome: "Home", navSupplier: "For Suppliers", navBuyer: "For Buyers", switchLang: "عربي", switchLink: "/ar/logistics",
  ...
  ar: {
    dir: "rtl",
    navHome: "الرئيسية", navSupplier: "للموردين", navBuyer: "للتجار", switchLang: "English", switchLink: "/en/logistics",
...
export default function LogisticsApplication() {
  ...
  return (
    <main dir={t.dir} className={`min-h-screen bg-gray-100 flex flex-col ${t.dir === 'rtl' ? cairo.className : inter.className}`}>
      ...
      {/* الصورة العلوية (البانر البرتقالي) */}
      <section className="relative w-full h-72 md:h-96 bg-cover bg-center flex flex-col items-center justify-center" style={{ backgroundImage: "url('/images/logistics-bg.jpg')" }}>
        ...
        <div className="relative z-10 text-center px-4 mt-8">
          ...
          <p className="text-orange-100 text-lg md:text-xl max-w-2xl mx-auto drop-shadow-md">{t.desc}</p>
        </div>
      </section>
